                ...
                >
                    ...
                    {visibleSections.map((section) => (
                        <SectionElement
                            ...
                            onSeatMouseDown={handleElementMouseDown}
                            onSeatRemove={removeElement}
                        />
                    ))}

                    {/* Standalone Seats (not in sections) */}
                    {visibleSeats
                        .filter(seat => !seat.sectionId) // Only render seats that don't belong to a section
                        .map((seat) => (
                            <SeatElement
                                key={seat.id}
                                seat={seat}
